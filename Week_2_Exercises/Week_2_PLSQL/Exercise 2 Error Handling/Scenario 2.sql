...
CREATE OR REPLACE PROCEDURE UpdateSalary (
    ...
    -- Declare a variable to hold the current salary
...
BEGIN
    -- Example: Increase salary by 10% for employee ID 1
    UpdateSalary(p_employee_id => 1, p_percentage => 10);
    
    -- Example: Try updating salary for a non-existent employee ID
    UpdateSalary(p_employee_id => 999, p_percentage => 5);
END;
/
